...
class UserManager(BaseUserManager):
    def create_user(self, email, first_name, last_name, phone_code, phone_number, gender, country, password=None, **extra_fields):
        ...
        user = self.model(email=email, first_name=first_name, last_name=last_name, phone_code=phone_code, phone_number=phone_number, gender=gender, country=country, **extra_fields)
    ...
    def create_superuser(self, email, first_name, last_name, phone_code, phone_number, gender, country, password=None, **extra_fields):
        ...
        return self.create_user(email, first_name, last_name, phone_code, phone_number, gender, country, password, **extra_fields)
